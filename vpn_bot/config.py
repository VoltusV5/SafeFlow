...
class Settings(BaseSettings):
    ...
    max_amnezia_keys_per_24h: int = Field(
        default=50, alias="MAX_AMNEZIA_KEYS_PER_24H"
    )  # noqa: E501
    ...
    telegram_mtproto_port: int = Field(
        default=8888, alias="TELEGRAM_MTPROTO_PORT"
    )  # noqa: E501
    ...
    telegram_socks_port: int = Field(
        default=64945, alias="TELEGRAM_SOCKS_PORT"
    )  # noqa: E501
    ...
    telegram_mtproto_secret: str = Field(
        default="", alias="TELEGRAM_MTPROTO_SECRET"
    )  # noqa: E501
    telegram_socks_user: str = Field(default="", alias="TELEGRAM_SOCKS_USER")
    telegram_socks_password: str = Field(
        default="", alias="TELEGRAM_SOCKS_PASSWORD"
    )  # noqa: E501
    ...
    telegram_http_proxy_user: str = Field(
        default="", alias="TELEGRAM_HTTP_PROXY_USER"
    )  # noqa: E501
    ...
    wg_client_ip_prefix: str = Field(
        default="10.8.0", alias="WG_CLIENT_IP_PREFIX"
    )  # noqa: E501
    # Параллельный Amnezia AWG для новых ключей (2.x стек / отдельный порт). Пусто — как раньше только AWG_DOCKER_CONTAINER.  # noqa: E501
    awg2_docker_container: str = Field(
        default="", alias="AWG2_DOCKER_CONTAINER"
    )  # noqa: E501
    ...
    wg2_server_public_key: str = Field(
        default="", alias="WG2_SERVER_PUBLIC_KEY"
    )  # noqa: E501
    wg2_client_ip_prefix: str = Field(
        default="10.8.2", alias="WG2_CLIENT_IP_PREFIX"
    )  # noqa: E501
    ...
    wireguard_endpoint_port: int = Field(
        default=40560, alias="WIREGUARD_ENDPOINT_PORT"
    )  # noqa: E501
    wireguard_client_prefix: str = Field(
        default="10.8.1", alias="WIREGUARD_CLIENT_PREFIX"
    )  # noqa: E501
    ...
    shadowsocks_public_port: int = Field(
        default=46768, alias="SHADOWSOCKS_PUBLIC_PORT"
    )  # noqa: E501
    xray_restart_container: bool = Field(
        default=True, alias="XRAY_RESTART_CONTAINER"
    )  # noqa: E501
    ...
    clean_xray_port_vless: int = Field(
        default=7443, alias="CLEAN_XRAY_PORT_VLESS"
    )  # noqa: E501
    clean_xray_port_trojan: int = Field(
        default=7444, alias="CLEAN_XRAY_PORT_TROJAN"
    )  # noqa: E501
    clean_xray_port_vmess: int = Field(
        default=7445, alias="CLEAN_XRAY_PORT_VMESS"
    )  # noqa: E501
    clean_xray_port_shadowsocks: int = Field(
        default=7446,
        alias="CLEAN_XRAY_PORT_SHADOWSOCKS",
    )
    clean_xray_api_port: int = Field(
        default=10085, alias="CLEAN_XRAY_API_PORT"
    )  # noqa: E501
    ...
    daemon_wg_interface: str = Field(
        default="awg0", alias="DAEMON_WG_INTERFACE"
    )  # noqa: E501
    daemon_net_interface: str = Field(
        default="eth0", alias="DAEMON_NET_INTERFACE"
    )  # noqa: E501
